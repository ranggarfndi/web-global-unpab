<nav x-data="{ 
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-20 items-center">
            ...
            <div class="hidden md:flex items-center space-x-1">
                ...
                {{-- ARCHIVES MENU --}}
                <a href="{{ route('archives.index') }}" class="{{ $navLinkClass }} {{ request()->routeIs('archives.*') ? $activeClass : '' }}">
                    Archives
                    {!! $underline !!}
                </a>
    ...
    <div x-show="mobileMenuOpen" 
        ...
        {{-- MOBILE ARCHIVES --}}
        <a href="{{ route('archives.index') }}" class="text-base font-bold text-green-900 hover:text-yellow-600 py-2 border-b border-slate-50">Archives</a>
